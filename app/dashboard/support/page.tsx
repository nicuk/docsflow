        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-6 mb-8">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <a
              ...
              className="text-center p-4 bg-white dark:bg-gray-800 rounded-lg hover:shadow-md transition-shadow"
            >
              <div className="text-2xl mb-2">📤</div>
              <div className="font-medium text-gray-900 dark:text-white">Upload Documents</div>
              <div className="text-sm text-gray-600 dark:text-gray-400">Start adding your files</div>
            </a>
            <a
            ...
            >
              <div className="text-2xl mb-2">💬</div>
              <div className="font-medium text-gray-900 dark:text-white">Ask Questions</div>
              <div className="text-sm text-gray-600 dark:text-gray-400">Start searching documents</div>
            </a>
          </div>
        </div>
