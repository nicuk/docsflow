...
export default function ContactForm() {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Book a 30-Minute Strategy Call</CardTitle>
        <CardDescription>
          Discover exactly how much time and money you're losing to document chaos. Most businesses find $8,000+ in monthly waste.
        </CardDescription>
      </CardHeader>
      <CardContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Textarea id="message" placeholder="Tell us about your specific requirements and use cases..." rows={3} />
              </div>
            </div>
          </div>
