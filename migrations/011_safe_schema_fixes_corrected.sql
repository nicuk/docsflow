-- SAFE SCHEMA FIXES - Corrected PostgreSQL Syntax
...
ALTER TABLE document_chunks DROP CONSTRAINT IF EXISTS document_chunks_tenant_id_fkey;

-- Step 4: Fix data type inconsistencies (CRITICAL)
...
-- Step 6: Update document_chunks to have proper tenant reference
ALTER TABLE document_chunks 
  ADD COLUMN IF NOT EXISTS tenant_id UUID;

-- Step 7: Add constraints (without IF NOT EXISTS)
ALTER TABLE documents 
...
-- Step 8: Update document_chunks with tenant_id for existing records
...
-- Step 11: Create improved RLS policies
